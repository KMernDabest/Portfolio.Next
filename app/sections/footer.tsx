...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white pt-14 pb-8 px-4 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-white/60 max-w-xs leading-relaxed">
              Aspiring software engineer based in Phnom Penh, Cambodia. Building clean, modern web &amp; mobile applications.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/40">
            &copy; {currentYear} Rith Seyhak. All rights reserved.
          </p>
          <p className="text-xs text-white/40">
