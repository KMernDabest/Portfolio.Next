              ...
              {[
                {
                  ...
                  label: "Email",
                  value: "rith.seyhak@email.com",
                  href: "mailto:rith.seyhak@email.com",
                },
                {
                  icon: (
                  ...
                  label: "GitHub",
                  value: "github.com/rithseyhak",
                  href: "https://github.com/rithseyhak",
                },
                {
                  icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  label: "LinkedIn",
                  value: "linkedin.com/in/rithseyhak",
                  href: "https://linkedin.com/in/rithseyhak",
                },
              ].map((contact, index) => (
                <motion.a
                  key={contact.label}
